...
const quizQuestions = [
    {    question: "Q1. Aline is currently a PhD candidate in:",
    answers: {
      a: "Mathematics",
      b: "Microbiology",
      c: "Marine Science",
  ...
  {    question: "Q2. Aline works at:",
    ...
    correctAnswer: "b"},
    {        question: "Q3: Aline's first position at QUT was as a:",
    answers: {
        a: "PhD student",
...
if (numCorrect === 1) { 
  ...
  if (numCorrect === 3) { 
    ...
    resultsContainer.innerHTML = "Congratulations! You got a perfect score for your responses.";
